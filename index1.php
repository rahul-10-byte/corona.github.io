	...
	<div class="row w-100 h-100">
		...
		<div class="col-lg-7 col-md-7 col-12 order-lg-2 order-1">
			<div class="rightside w-100 h-100 d-flex justify-content-center align-items-center">
				<h1>Let's Stay Safe & Fight Together Against Cor <span class="corona_rot"><img src="images/coronavirus1.png"></span> na virus</h1>
			</div>
		</div>	
	</div>	
</div>
		...
		<div class="row">
			<div class="col-lg-8 offset-lg-2 col-12">
				...
				<form action="" method="POST">
					...
					<div class="form-group">
  						  <label>Mobile :</label>
   								 <input type="number" class="form-control" name="mobile" placeholder="Mobile No." autocomplete="off">
 					</div>
